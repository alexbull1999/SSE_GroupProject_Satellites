...
@login_bp.route("/account/<username>")
...
@login_bp.route("/add_satellite", methods=["POST"])
def add_satellite():
...
@login_bp.route("/add_country", methods=["POST"])
def add_country():
    try:
        data = request.get_json()  # This will parse the incoming JSON
        username = data.get("username")
...
@login_bp.route("/delete_satellite", methods=["POST"])
...
@login_bp.route("/delete_country", methods=["POST"])
def delete_country():
    try:
        data = request.get_json()  # This will parse the incoming JSON
        username = data.get("username")

...
def get_satellites_over_country():
    ...
    # Render the country.html page with an error if the input country is
    # not in the country database
    ...
    url = (
        f"{N2YO_API_BASE}above/{observer_lat}/{observer_lng}/{observer_alt}/"
